...
public class Statics {
    ...
    public static ArrayList<Boolean> esconderApio1 = new ArrayList<>();
    public static ArrayList<Boolean> esconderSulfitos1 = new ArrayList<>();
    public static ArrayList<Boolean> esconderMoluscos1 = new ArrayList<>();
    ...
    public static ArrayList<Boolean> esconderApio2 = new ArrayList<>();
    public static ArrayList<Boolean> esconderSulfitos2 = new ArrayList<>();
    public static ArrayList<Boolean> esconderMoluscos2 = new ArrayList<>();
